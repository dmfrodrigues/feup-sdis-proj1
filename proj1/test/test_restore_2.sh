...
echo "Started peers with PIDs $PID1, $PID2, $PID3"
sleep 1
...
sleep 2
test "test-restore-2-01" "cat source_Release" "cat testfiles/source_Release"
...
sleep 2
test "test-restore-2-02" "cat Release" "cat testfiles/Release"
