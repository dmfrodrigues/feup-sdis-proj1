...
sleep 2
test "test-restore-6-01" "cat source_Release" "cat testfiles/source_Release"
...
sleep 2
test "test-restore-6-02" "cat Release" "cat testfiles/Release"
...
sleep 10
test "test-restore-6-03" "cat ChangeLog" "cat testfiles/ChangeLog"
