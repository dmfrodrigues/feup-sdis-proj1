...
test "test1-01-1" "timeout $TIMEOUT java TestApp service1 BACKUP source_Release 1" "echo"
sleep 2
...
test "test1-02-1" "timeout $TIMEOUT java TestApp service1 BACKUP Release 1" "echo"
sleep 3
